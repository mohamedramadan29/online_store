                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 col-xs-3">
                                        <img class="img-responsive"
                                             src="{{\Illuminate\Support\Facades\Storage::url($cart->Product->image)}}"/>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="col-xs-12">{{$cart->Product->name}}</div>
                                        <div class="col-xs-12"><small>Quantity:<span>{{$cart->qty}}</span></small></div>
                                    </div>
                                    <div class="col-sm-3 col-xs-3 text-right">
                                        <h6><span>$</span>{{number_format($cart->Product->price)}}</h6>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="zip_code" class="form-control" value="{{$user->pincode}}"/>
                                </div>
                            </div>
                            <div class="form-group">
